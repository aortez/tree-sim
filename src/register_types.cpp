...
{
// Initialization.
GDExtensionBool GDE_EXPORT treesim_library_init(
        ...
        GDExtensionInitialization *r_initialization)
{
    ...
    init_obj.register_initializer(initialize_treesim_module);
    init_obj.register_terminator(uninitialize_treesim_module);
